      ...
      <div className="container mx-auto my-8">
         ...
         <div className="mt-4">
            <table className="border border-gray-300 rounded-lg w-full">
               ...
               <tr>
                  <th className="p-2 border-b border-gray-300 text-left font-bold">Thành phố</th>
                  <th className="p-2 border-b border-gray-300 text-left font-bold">Chỉ số AQI</th>
               </tr>
               </thead>
               <tbody>
               {aqiData.cities.map((cityAqi, index) => (
                  <tr key={index} className="text-left">
                     <td className="p-2 border-b border-gray-200 font-bold">{cityAqi.city}</td>
