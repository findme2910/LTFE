   ...
   return (
      <div>
         ...
         <div className='bg-[#017cc2] text-white'>
            ...
            {/*rule*/}
            <div className='mt-4 ml-4 md:ml-14 mr-4 md:mr-16'>
               <div className='w-full border-t border-gray-300'></div>
            </div>

            <div className='p-4'>
               <div className='relative flex flex-col items-center md:items-start'>
                  <div className='absolute -top-16 md:left-0 md:top-0 md:ml-4 md:mt-4 w-1/2 md:w-1/4'>
                     <img
                        loading='lazy'
                  ...
                  <div className='container mx-auto p-4 flex justify-center md:justify-end'>
                     <div className='w-full md:w-2/3'>
                        <p className='text-2xl font-bold text-center md:text-left'>Nhật báo Thanh Niên</p>
                        <p className='text-sm text-center md:text-left'>5.500đ/số</p>
                        <div className='mt-4 flex flex-col md:flex-row justify-around items-center text-white space-y-4 md:space-y-0'>
                           <div className='text-center px-4 md:px-10 py-2'>
                           ...
                           <div className='hidden md:block border-l-2 border-white h-16'></div>
                           <div className='text-center px-4 md:px-10 py-2'>
         ...
         <div className='py-2 mt-20'>
            <div className='container mx-auto p-4'>
               <div className='text-sm'>
                  ...
                  <div className='p-4'>
                     <div className='flex flex-col md:flex-row'>
                        ...
                        <div className='hidden md:block border-l-2 border-gray-200 mx-4 ml-16'></div>
                        <div className='col'>
               ...
               <div className='flex flex-col md:flex-row flex-wrap text-sm'>
                  {/* Đồng Nai Section */}
                  ...
                  <div className='md:block border-l-2 border-gray-200 mx-4 ml-7 '></div>
                  {/* Cần Thơ Section */}
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
               ...
               <div className='flex flex-col md:flex-row flex-wrap text-sm mt-6'>
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
                           4
                  ...
                  <div className='hidden md:block border-l-2 border-gray-200 mx-4 ml-13'></div>
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
                           5
               ...
               <div className='flex flex-col md:flex-row flex-wrap text-sm mt-6'>
                  ...
                  <div className='hidden md:block border-l-2 border-gray-200 mx-4 ml-15'></div>
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
                           7
               ...
               <div className='flex flex-col md:flex-row flex-wrap text-sm mt-6'>
                  ...
                  <div className='hidden md:block border-l-2 border-gray-200 mx-4 ml-17'></div>
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
                           9
               ...
               <div className='flex flex-col md:flex-row flex-wrap text-sm mt-6'>
                  ...
                  <div className='hidden md:block border-l-2 border-gray-200 mx-4 ml-7'></div>
                  <div className='flex flex-col'>
                     <div className='flex items-center'>
                        <span className='flex items-center justify-center w-6 h-6 bg-primaryColor text-white rounded-full text-xs font-bold'>
                           11
