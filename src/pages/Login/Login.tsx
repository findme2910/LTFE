            ...
            <form action="" className='form-login ng-scope ng-pristine ng-valid'>
               ...
               <div className="login-network">
                  ...
                  <div className="login-social-network">
                     <a href="#" className="link-network"
                        ...
                        <svg className="icon-network" width="25" height="24" viewBox="0 0 25 24" fill="none"
                     ...
                     <a href="#" className="link-network" data-ng-click="authExternalProvider('Zalo')">
                        <img src="https://my.thanhnien.vn/image/icon_zalo_full%20color.png" alt=""
               ...
               <div className="login-cnt">
                  <div id="menu_1" className="login-form-1">
                     ...
                     <a href="/quen-mat-khau" className="forget-password" target="_blank">Quên mật khẩu?</a>
